...
from neural import LatticeClassifier,ConvClassifier, MLPClassifier
...
for trial in range(n_trials):
    ...
    model = MLPClassifier(feature_dim,n_features,n_classes)
    ...
    for epoch in range(n_epochs): 
        ...
        print('Testing accuracy of MLPClassifier...')
        total = 0.0
        correct = 0
        with torch.no_grad():
...
torch.save(train_accuracy,'./fc_train_accuracy.pt')
torch.save(test_accuracy,'./fc_test_accuracy.pt')
